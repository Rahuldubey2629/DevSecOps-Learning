      ...
      <div className="app-body">
        <aside className="sidebar slide-in-left">
          ...
          <ul className="social-links">
            ...
            <li><a className="sidebar-btn" href="https://www.youtube.com/@devops" target="_blank" rel="noopener noreferrer">YouTube</a></li>
            <li><a className="sidebar-btn" href="https://www.instagram.com/devops" target="_blank" rel="noopener noreferrer">Instagram</a></li>
          </ul>
        </aside>
